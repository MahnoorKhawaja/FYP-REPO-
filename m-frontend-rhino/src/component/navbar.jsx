        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 bg-slate-900 border-t border-slate-700 sm:px-3">
              <Link to="/" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-base font-medium text-gray-700 transition-colors duration-200 border-l-4 border-transparent rounded-lg hover:text-blue-600 hover:bg-blue-50 hover:border-blue-600">Home</Link>
              <Link to="/features" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-base font-medium text-gray-700 transition-colors duration-200 border-l-4 border-transparent rounded-lg hover:text-blue-600 hover:bg-blue-50 hover:border-blue-600">Features</Link>
              
              <Link to="/pricing" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-base font-medium text-gray-700 transition-colors duration-200 border-l-4 border-transparent rounded-lg hover:text-blue-600 hover:bg-blue-50 hover:border-blue-600">Pricing</Link>
              <Link to="/demo" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-base font-medium text-gray-700 transition-colors duration-200 border-l-4 border-transparent rounded-lg hover:text-blue-600 hover:bg-blue-50 hover:border-blue-600">Demo</Link>
              <Link to="/about" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-base font-medium text-gray-700 transition-colors duration-200 border-l-4 border-transparent rounded-lg hover:text-blue-600 hover:bg-blue-50 hover:border-blue-600">About</Link>
              <Link to="/career" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-base font-medium text-gray-700 transition-colors duration-200 border-l-4 border-transparent rounded-lg hover:text-blue-600 hover:bg-blue-50 hover:border-blue-600">Careers</Link>
              <Link to="/contact" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-base font-medium text-gray-700 transition-colors duration-200 border-l-4 border-transparent rounded-lg hover:text-blue-600 hover:bg-blue-50 hover:border-blue-600">Contact</Link>
              <Link to="/privacy" onClick={() => setIsOpen(false)} className="block px-3 py-3 text-base font-medium text-gray-700 transition-colors duration-200 border-l-4 border-transparent rounded-lg hover:text-blue-600 hover:bg-blue-50 hover:border-blue-600">Privacy</Link>
